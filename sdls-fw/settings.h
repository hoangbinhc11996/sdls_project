...
#define SDLS_VERSION "0.1"

// Version of the EEPROM data. Will be used to migrate existing data from older versions of SDLS
...
// Define EEPROM memory address location values for SDLS settings and parameters

    ...
    def _initialize_settings(self):
        ...
        self._add_setting(
            Setting('machine_model_path', _('Machine model'), 'machine_settings',
                    unicode, unicode(resources.get_path_for_mesh('sdls_platform.stl'))))
        # self._add_setting(
        ...
        self._add_setting(
            Setting('language', _('Language'), 'preferences', unicode, u'English',
                    ...
                    tooltip=_('Change the language of sdls. '
    ...
    def _check_type(self, value):
        if not isinstance(value, self._type):
            raise TypeError("Error when setting %s.\n%s (%s) is not of type %s. "
                            "Please remove current profile at ~/.sdls" %
...
def get_base_path():
    ...
    if system.is_windows():
        ...
        basePath = os.path.expanduser('~/.sdls/')

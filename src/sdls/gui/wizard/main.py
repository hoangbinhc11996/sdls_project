...
from sdls.gui.wizard.connection_page import ConnectionPage
from sdls.gui.wizard.calibration_page import CalibrationPage
from sdls.gui.wizard.scanning_page import ScanningPage

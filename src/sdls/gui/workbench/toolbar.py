...
from sdls.util import resources, system

from sdls.gui.engine import driver
...
class Toolbar(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.combo = wx.ComboBox(self, -1, size=(320, -1), style=wx.CB_READONLY)

        # Layout
        hbox = wx.BoxSizer(wx.HORIZONTAL)
        hbox.Add(self.combo, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 20)

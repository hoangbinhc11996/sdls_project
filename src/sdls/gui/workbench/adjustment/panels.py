# -*- coding: utf-8 -*-
from sdls.util import profile, system as sys

from sdls.gui.engine import image_capture, laser_segmentation

from sdls.gui.workbench.adjustment.current_video import CurrentVideo
from sdls.gui.util.custom_panels import ExpandablePanel, Slider, ComboBox, CheckBox

...
from sdls.gui.engine import driver, pattern, calibration_data, image_capture
from sdls.gui.util.video_view import VideoView
from sdls.gui.workbench.workbench import Workbench
from sdls.gui.workbench.adjustment.current_video import CurrentVideo
from sdls.gui.workbench.adjustment.panels import ScanCapturePanel, ScanSegmentationPanel, \

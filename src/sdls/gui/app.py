...
from sdls.gui.main import MainWindow
from sdls.gui.splash import SplashScreen
from sdls.gui.welcome import WelcomeDialog

from sdls.util import profile, resources, version, system as sys
from sdls.gui.util.version_window import VersionWindow


class SDLsApp(wx.App):

    def __init__(self):
        super(SDLsApp, self).__init__(redirect=False)
